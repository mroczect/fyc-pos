...
use crate::repositories::traits::ProductRepository;
...
impl ProductRepo {
    ...
    pub fn create(&self, name: &str, price: f64, category: &str) -> Result<i64, DbError> {
        <Self as ProductRepository>::create(self, name, price, category)
    }

    pub fn find_by_id(&self, id: i64) -> Result<Option<Product>, DbError> {
        <Self as ProductRepository>::find_by_id(self, id)
    }

    pub fn find_all_active(&self) -> Result<Vec<Product>, DbError> {
        <Self as ProductRepository>::find_all_active(self)
    }

    pub fn update(&self, id: i64, name: &str, price: f64, category: &str) -> Result<(), DbError> {
        <Self as ProductRepository>::update(self, id, name, price, category)
    }

    pub fn deactivate(&self, id: i64) -> Result<(), DbError> {
        <Self as ProductRepository>::deactivate(self, id)
    }
    ...
    pub fn query_by_id(conn: &rusqlite::Connection, id: i64) -> Result<Option<Product>, DbError> {
    ...
    pub fn query_all_active(conn: &rusqlite::Connection) -> Result<Vec<Product>, DbError> {
        let mut stmt = conn.prepare(
